...
yukiCFA(
  data = df.raw,
  model = "OSC =~ OSC1 + OSC2 + OSC3 + OSC4 + OSC5 + OSC7",
...
yukiCFA(
  data = df.raw,
  model = "UI =~ UI1 + UI2 + UI3",
  path = "./OUTPUT/CFA/UI.md"
)
```
...
yukiCFA(
  data = df.raw,
  model = "UC =~ UC1 + UC2 + UC3",
  path = "./OUTPUT/CFA/UC.md"
)
```
...
yukiCFA(
  data = df.raw,
  model = "DI =~ DI1 + DI2 + DI3",
  path = "./OUTPUT/CFA/DI.md"
)
```
...
yukiCFA(
  data = df.raw,
  model = "DC =~ DC1 + DC2 + DC3",
  path = "./OUTPUT/CFA/DC.md"
)
```
...
yukiCFA(
  data = df.raw,
  model = "Blue =~ Blue1 + Blue2 + Blue3 + Blue4 + Blue5 + Blue6 + Blue7",
  path = "./OUTPUT/CFA/Blue.md"
)
```
